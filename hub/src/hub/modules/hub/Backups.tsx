  ...
  return (
    <div style={styles.container} className="animate-fade-in">
      ...
      <div style={styles.statsGrid}>
         ...
         <div style={styles.statCard}>
            <div style={{...styles.statIcon, backgroundColor: 'rgba(217, 255, 0, 0.12)'}}><Activity size={24} color="#D9FF00" /></div>
            <div>
...
const styles = {
  ...
  searchInput: { border: 'none', outline: 'none', fontSize: '14px', fontWeight: '700', color: '#000000', width: '100%' },
