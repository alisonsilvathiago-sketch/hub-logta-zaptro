...
const styles: Record<string, any> = {
  ...
  badge: { fontSize: '10px', fontWeight: '700', color: 'var(--primary)', letterSpacing: '1px', marginBottom: '8px', opacity: 0.8 },
  ...
  saveBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 28px', backgroundColor: 'var(--primary)', color: 'white', border: 'none', borderRadius: '14px', fontWeight: '600', cursor: 'pointer' },
  ...
  tabTitle: { fontSize: '20px', fontWeight: '700', color: '#000000', marginBottom: '8px' },
  ...
  colorName: { fontSize: '14px', fontWeight: '600', margin: 0 },
  ...
  logoPreview: { width: '48px', height: '48px', backgroundColor: 'var(--primary)', color: 'white', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '700', fontSize: '20px' },
  secondaryBtn: { padding: '8px 16px', backgroundColor: 'white', border: '1px solid #e2e8f0', borderRadius: '10px', fontSize: '12px', fontWeight: '600', cursor: 'pointer' }
};
