        ...
        {activeTab === 'logs' && (
          <div style={s.tabContent}>
            <div style={s.card}>
              ...
              {[
                { event: 'OpenAI GPT-4o Response', client: 'Transcontinental S.A.', time: '14:35:12', cost: 'R$ 0,08', status: 'Success' },
                { event: 'Evolution API: Message Sent', client: 'Transportadora Falcão', time: '14:34:01', cost: 'R$ 0,01', status: 'Success' },
                { event: 'Anthropic Claude-3.5', client: 'Logística Express XPTO', time: '14:30:45', cost: 'R$ 0,12', status: 'Success' },
                { event: 'Evolution API: Bulk Start', client: 'Transcontinental S.A.', time: '14:10:00', cost: 'R$ 5,40', status: 'Success' },
              ].map((log, i) => (
