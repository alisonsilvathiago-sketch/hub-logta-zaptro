...
import type { MasterCatalogProduct, MasterProductType } from '@core/types/index';
...
const styles: Record<string, any> = {
  ...
  saveBtn: { padding: '0 24px', height: '45px', backgroundColor: 'var(--primary)', color: 'white', border: 'none', borderRadius: '12px', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' },
  ...
  tabLink: { padding: '10px 20px', borderRadius: '12px', fontSize: '13px', fontWeight: '600', color: '#64748b', cursor: 'pointer', transition: 'all 0.2s', display: 'flex', alignItems: 'center', gap: '8px' },
  ...
  planCategory: { fontSize: '9px', fontWeight: '700', color: 'var(--primary)', display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '12px', opacity: 0.8 },
  planName: { fontSize: '18px', fontWeight: '700', color: 'var(--text-main)', marginBottom: '4px' },
  planPrice: { fontSize: '20px', fontWeight: '700', color: 'var(--text-main)' },
  priceSymbol: { fontSize: '12px', color: '#94a3b8', fontWeight: '700' },
  creditBadge: { display: 'inline-flex', alignItems: 'center', gap: '4px', padding: '4px 8px', backgroundColor: '#fff7ed', color: '#ea580c', borderRadius: '8px', fontSize: '10px', fontWeight: '700', marginTop: '12px' },
  ...
  fLabel: { fontSize: '11px', fontWeight: '700', color: '#64748b', textTransform: 'uppercase' as const },
  ...
  saveBtnModal: { padding: '16px', backgroundColor: 'var(--primary)', color: 'white', border: 'none', borderRadius: '14px', fontWeight: '700', cursor: 'pointer', marginTop: '10px' }
};
