...
import { profileHasZaptroProductAccess } from '@core/utils/authProductGate';
import { fetchProfileSliceForGate } from '@core/utils/profileSelectFallback';
import { 
  Lock, Mail, ArrowRight, Eye, EyeOff, Zap, Loader2,
  AlertCircle
} from 'lucide-react';
import toast from 'react-hot-toast';
import { notifyZaptro } from '@shared/components/Zaptro/ZaptroNotificationSystem';
import { isZaptroLocalhostDev } from '@core/utils/zaptroDevBypass';
import { getZaptroPostLoginLandingUrl } from '@core/utils/domains';
import { ZAPTRO_HERO_SPLIT_PANEL_CLASS, zaptroHeroSplitPanelCss } from '@core/utils/zaptroMarketingHeroBackground';
import ZaptroHeroParticleCanvas from '@shared/components/Zaptro/ZaptroHeroParticleCanvas';
import { postZaptroPasswordResetNotice } from '@core/lib/zaptroMailApi';
