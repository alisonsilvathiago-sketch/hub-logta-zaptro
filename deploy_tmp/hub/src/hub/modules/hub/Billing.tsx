...
const MasterBilling = ({ summaryOnly = false }: { summaryOnly?: boolean }) => {
  ...
  const revenueChartData = [
    ...
    { name: 'Fev', value: 0 },
    { name: 'Mar', value: 0 },
    { name: 'Abr', value: Math.max(0, Number(metrics.mrr)) || 0 },
  ];
  ...
  const revenueData = [
    ...
    { month: 'Fev', mrr: 0, new: 0 },
    { month: 'Mar', mrr: 0, new: 0 },
    { month: 'Abr', mrr: Math.max(0, Number(metrics.mrr)) || 0, new: Math.max(0, Number(metrics.activeTenants)) || 0 },
  ];
