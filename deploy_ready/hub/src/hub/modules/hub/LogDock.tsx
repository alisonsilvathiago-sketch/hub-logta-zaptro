...
const HubLogDock: React.FC = () => {
  ...
  const initDefaultFolders = async () => {
    ...
    const defaults = [
      '📄 Logta · XMLs e documentos fiscais',
      '🧾 Logta · Comprovantes (POD)',
      '📑 Logta · Contratos',
      '👤 Logta · Avatares e biblioteca do perfil',
      '📦 Entregas Ativas',
      '🚚 Operações Diárias',
      '💬 Conversas WhatsApp',
    ];
          ...
          {activeTab === 'all' && !searchTerm && (
            <div style={styles.dashboardSection}>
               ...
               <div style={{ ...HUB_METRIC_GRID_STYLE, marginBottom: 0 }}>
                  ...
                  <HubMetricCard label="Pendências POD" value={0} icon={AlertTriangle} accent="#EF4444" softBg="#FEF2F2" />
               </div>
            </div>
          )}
