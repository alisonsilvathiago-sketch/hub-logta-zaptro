...
const ALL_COMMANDS: PaletteCmd[] = [
  ...
  { id: 'logta-saas', title: 'Logta SaaS (Master)', keywords: 'erp logística frota empresas', icon: <PackageSearch size={18} />, path: '/master/logta' },
  { id: 'zaptro-saas', title: 'Zaptro SaaS (Master)', keywords: 'whatsapp crm comercial motoristas frota', icon: <MessageCircle size={18} />, path: '/master/zaptro' },
  ...
  { id: 'ia-gateway', title: 'IA Gateway', keywords: 'llm tokens modelos inteligência artificial', icon: <Brain size={18} />, path: '/master/ia-gateway' },
            ...
            commands.map((cmd, i) => (
              ...
              >
                <div style={{
                  ...
                  color: i === selectedIndex ? 'white' : '#949494',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  transition: 'all 0.15s ease'
