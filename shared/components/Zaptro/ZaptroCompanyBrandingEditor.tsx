...
const st = {
  brandModalSub: { margin: '4px 0 0', fontSize: 14, lineHeight: 1.4, fontWeight: 600 } as const,
  brandModalBody: { marginBottom: 24, marginTop: 24 } as const,
  brandFieldLbl: {
    display: 'block',
    fontSize: 12,
    fontWeight: 700,
  ...
  brandHint: { margin: '8px 0 0', fontSize: 13, lineHeight: 1.5, fontWeight: 500, opacity: 0.7 } as const,
  brandColorRow: { display: 'flex', gap: 16, flexWrap: 'wrap' } as const,
  brandColorPair: { display: 'flex', alignItems: 'center', gap: 12, marginTop: 0 } as const,
  brandColorHexInput: {
    width: 120,
    padding: '12px',
    borderRadius: 14,
