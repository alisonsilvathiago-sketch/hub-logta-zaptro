  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: '#fff', zIndex: 99999, padding: '60px', overflowY: 'auto', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="no-print" style={{ position: 'fixed', top: '20px', right: '20px', display: 'flex', gap: '12px' }}>
        ...
        <button onClick={onClose} style={{ background: '#F1F5F9', color: '#949494', border: 'none', padding: '10px 20px', borderRadius: '12px', fontWeight: '800', cursor: 'pointer' }}>FECHAR</button>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '60px', borderBottom: '2px solid #F1F5F9', paddingBottom: '30px' }}>
        <div>
          ...
          <div style={{ fontSize: '14px', color: '#949494' }}>Gestão Centralizada de SaaS</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px', marginBottom: '60px' }}>
        <div>
          ...
          <div style={{ fontSize: '14px', color: '#949494' }}>{invoice.companies?.email || 'contato@cliente.com.br'}</div>
        </div>
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: '11px', fontWeight: '800', color: '#94A3B8', textTransform: 'uppercase', marginBottom: '12px' }}>DETALHES DO PAGAMENTO:</div>
          <div style={{ fontSize: '14px', color: '#949494', marginBottom: '4px' }}>Data de Emissão: {new Date(invoice.created_at).toLocaleDateString()}</div>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '60px' }}>
        <thead>
          <tr style={{ background: '#F8FAFC' }}>
            <th style={{ padding: '16px 20px', textAlign: 'left', fontSize: '12px', fontWeight: '800', color: '#949494', borderBottom: '1px solid #E2E8F0' }}>DESCRIÇÃO DO SERVIÇO</th>
            <th style={{ padding: '16px 20px', textAlign: 'right', fontSize: '12px', fontWeight: '800', color: '#949494', borderBottom: '1px solid #E2E8F0' }}>VALOR</th>
          </tr>
        </thead>
        <tbody>
          <tr>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
        <div style={{ width: '300px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
            <div style={{ color: '#949494', fontWeight: '600' }}>Subtotal:</div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px', paddingBottom: '12px', borderBottom: '1px solid #E2E8F0' }}>
            <div style={{ color: '#949494', fontWeight: '600' }}>Impostos (0%):</div>
