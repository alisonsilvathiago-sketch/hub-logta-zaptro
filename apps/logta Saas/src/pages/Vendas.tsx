...
import vendasConfiancaLogistica from '@/assets/vendas-confianca-logistica.png';
...
const Vendas = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] text-gray-900 font-sans selection:bg-primary/25 overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-black/90 backdrop-blur-md">
        <div className="max-w-7xl mx-auto h-16 md:h-[72px] px-4 sm:px-6 lg:px-10 flex items-center">
          ...
          <nav className="hidden lg:flex flex-1 justify-center items-center gap-7 xl:gap-9 text-[13px] font-semibold text-white/85">
      ...
      <section className="relative z-20 isolate h-[1250px] bg-black text-white pt-[110px] pb-[110px] px-0 overflow-hidden">
        <div className="relative z-[1] mx-auto h-[342px] max-w-[901px] text-center px-2">
          <h1 className="box-content text-[1.65rem] leading-[1.15] sm:text-4xl md:text-5xl lg:text-[64px] font-bold tracking-[-0.02em] pt-[2px] pb-[2px] mt-7 mb-7 h-[149px] overflow-visible bg-gradient-to-r from-white via-white to-sky-400 bg-clip-text text-transparent">
            O cérebro <em className="italic font-black">digital</em> da
            <br />
            sua operação logística.
          </h1>
          <p className="mt-5 md:mt-6 text-sm sm:text-base md:text-lg text-white/75 font-medium max-w-2xl mx-auto leading-relaxed px-[115px]">
        ...
        <div
          id="demo"
          className="relative z-[1] mx-auto mt-14 md:mt-20 max-w-5xl min-h-[700px] scroll-mt-28 flex justify-center overflow-visible"
        >
          <img
            src={vendasHeroContainers}
            alt="Containers Logta em operação logística"
            className="box-content mx-0 -my-[99px] flex flex-col items-center justify-start gap-0 overflow-visible p-0 h-[789px] w-[1036px] max-w-full object-contain object-center origin-center will-change-transform"
            decoding="async"
            loading="lazy"
          />
      ...
      >
        <div className="max-w-6xl mx-auto w-full flex flex-col items-center gap-8 md:gap-10 py-0">
      ...
      <section id="recursos" className="scroll-mt-24 py-1.5 px-5 md:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
            <h2 className="text-3xl md:text-[43px] font-bold text-gray-900 tracking-[-1.3px] leading-[48px] h-[100px] mx-[63px]">
              Menos custo na rodovia, mais lucro no seu caixa.
            </h2>
            <p className="mt-4 h-[61px] text-gray-600 font-medium leading-relaxed text-sm md:text-base">
          ...
          <div className="mt-16 md:mt-24 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center justify-center">
            <div className="rounded-[2rem] bg-gray-100 border border-gray-200/90 p-6 md:p-8 shadow-inner h-[582px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 items-stretch">
            ...
            <div className="rounded-[2rem] bg-gray-100 border border-[rgba(112,141,255,0.9)] p-6 md:p-8 flex flex-col shadow-sm">
              ...
              <div className="mt-6 flex-1 rounded-2xl bg-white border border-gray-100 overflow-hidden shadow-sm">
                <img
                  src={vendasConfiancaLogistica}
                  alt="Equipe e caminhão com branding Logta em operação logística"
