...
import { HelpCircle, ExternalLink, MessageSquare, Phone, BookOpen, DollarSign, ArrowLeft } from 'lucide-react';
...
const Ajuda = () => {
  ...
  return (
    <div className="px-16 py-10 w-full h-full animate-in fade-in duration-500 text-left flex flex-col justify-center items-center">
      {/* Main Help Hub Card */}
      <div className="bg-white border border-gray-100 rounded-[40px] p-10 max-w-4xl w-full shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-900 tracking-tight">Canais de Ajuda</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 space-y-3">
              ...
              <button 
                onClick={() => {
                  if ((window as any).showToast) {
                    (window as any).showToast('info', 'IA ativada! Clique na bolha do cérebro no canto inferior esquerdo para conversar.', 'Logta AI');
                  }
                }}
