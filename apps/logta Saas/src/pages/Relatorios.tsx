...
const Relatorios = () => {
  ...
  const tabs = [
    { id: 'dashboard', label: 'Dashboard BI', icon: BarChart3, path: '/relatorios/dashboard' },
    { id: 'operacional', label: 'Relatório Operacional', icon: Truck, path: '/relatorios/operacional' },
    { id: 'financeiro', label: 'Relatório Financeiro', icon: FileBarChart, path: '/relatorios/financeiro' },
    { id: 'clientes', label: 'Inteligência de Clientes', icon: Users, path: '/relatorios/clientes' },
  ];
  ...
  return (
    <div className="px-16 py-10 w-full h-full space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex justify-between items-end h-[87px]">
        <div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight h-[46px] mt-[74px]">Relatórios</h1>
          <p className="text-xs text-gray-400 font-medium mt-1">Análise profunda de dados para tomada de decisão estratégica.</p>
        </div>
        <div className="flex gap-3">
          <button className="px-6 py-3.5 bg-gray-900 text-white rounded-xl text-sm font-bold hover:bg-black transition-all shadow-xl shadow-black/10 flex items-center gap-2 cursor-pointer">
            <BrainCircuit size={16} fill="currentColor" /> Insights de IA
          </button>
      ...
      <div className="flex items-center gap-2 p-1.5 bg-gray-100 rounded-[24px] w-fit">
        {tabs.map((tab) => {
          const Icon = tab.icon;
          const isActive = location.pathname.startsWith(tab.path) || (location.pathname === '/relatorios' && tab.id === 'dashboard');
          return (
            <Link
              key={tab.id}
              to={tab.path}
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 bg-white border border-gray-200 rounded-[40px] p-8 shadow-sm">
        <div className="flex justify-between items-center mb-8">
          <h3 className="text-xl font-bold text-gray-900 tracking-tight">Crescimento de Receita vs Meta</h3>
...
const RelatorioOperacionalView = () => (
  <div className="space-y-6">
        ...
        <div key={i} className="bg-white border border-gray-100 p-6 rounded-[32px] shadow-sm flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h4 className="text-xl font-black text-gray-900">{m.value}</h4>
            </div>
          </div>
    ...
    <div className="bg-white border border-gray-200 rounded-[40px] p-8 shadow-sm">
      <div className="flex justify-between items-center mb-8">
        <h3 className="text-xl font-bold text-gray-900">Desempenho por Região</h3>
...
const RelatorioFinanceiroView = () => (
  <div className="space-y-8">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div className="bg-white border border-gray-200 rounded-[40px] p-8 shadow-sm">
        <h3 className="text-xl font-bold text-gray-900 mb-8">Evolução de Margem de Lucro</h3>
      ...
      <div className="bg-white border border-gray-200 rounded-[40px] p-8 shadow-sm">
        <h3 className="text-xl font-bold text-gray-900 mb-8">Análise de Inadimplência</h3>
        <div className="space-y-6">
          {[
...
const RelatorioClientesView = () => (
  <div className="space-y-6">
    <div className="bg-white border border-gray-200 rounded-[40px] p-8 shadow-sm overflow-hidden">
      <div className="flex justify-between items-center mb-8">
        <h3 className="text-xl font-bold text-gray-900 tracking-tight">Ranking de Clientes Mais Lucrativos</h3>
