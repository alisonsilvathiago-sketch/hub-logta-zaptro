...
const Automacoes = () => {
  ...
  return (
    <div className="px-16 py-10 w-full h-full space-y-8 animate-in fade-in duration-500 text-left overflow-y-auto scrollbar-hide">
      
      {/* Header */}
      <div className="flex justify-between items-end h-[87px]">
        <div>
          <h1 className="text-4xl font-black text-gray-900 tracking-tight flex items-center gap-3 h-[46px] mt-[74px]">
            <Cpu size={36} className="text-primary animate-pulse" /> Automações & Regras
          </h1>
          <p className="text-xs text-gray-400 font-medium mt-1">Crie fluxos de trabalho inteligentes, conecte módulos do sistema e elimine tarefas manuais.</p>
        </div>
        <button 
      ...
      <div className="flex items-center gap-2 p-1.5 bg-gray-100 rounded-[24px] w-fit">
        {[
          { id: 'workflows', label: 'Painel de Fluxos', icon: Layers },
          { id: 'editor', label: 'Criador Visual (Estilo Zapier)', icon: GitFork },
          { id: 'logs', label: 'Histórico de Logs', icon: History },
          { id: 'regras', label: 'Regras Gerais', icon: Sliders },
        ].map((tab) => {
          const Icon = tab.icon;
              ...
              {[
                ...
                <div key={i} className="bg-white border border-gray-100 p-6 rounded-[32px] shadow-sm relative overflow-hidden group">
                  ...
                  <div className="flex items-baseline gap-2">
                    <h4 className={`text-3xl font-black ${m.color}`}>{m.value}</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-900 rounded-[40px] p-8 text-white relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10 space-y-6">
                ...
                <h3 className="text-xl font-bold tracking-tight">Segurança no Piloto Automático</h3>
