...
export { normalizeShipment, computeFretesAnalytics, FRETES_STATUS_LABELS } from './fretesAnalytics';
export { buildFretesAlerts, buildFretesIaInsights } from './fretesIntelligence';
