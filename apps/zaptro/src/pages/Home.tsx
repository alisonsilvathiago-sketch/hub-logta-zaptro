...
const Home: React.FC = () => {
  ...
  const isZaptro = context === 'WHATSAPP' || hostname === 'zaptro.com.br' || hostname === 'www.zaptro.com.br';
  const isLocalDev =
        ...
        >
           ...
           <div style={styles.heroContent}>
              ...
              <div style={styles.heroActions}>
                 <button style={styles.btnPrimary} onClick={() => handleNavigate(ZAPTRO_ROUTES.REGISTER)}>
                    PRIMEIROS PASSOS <ArrowRight size={20} />
                 </button>
                 <button style={styles.btnSecondary} onClick={() => handleNavigate('/login')}>
        ...
        <div style={{ maxWidth: '520px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <button
              ...
              onClick={() => handleNavigate(ZAPTRO_ROUTES.REGISTER)}
            >
    ...
    >
      ...
      <div style={{ maxWidth: '520px' }}>
        ...
        <p style={{ color: '#94a3b8', lineHeight: 1.6, fontSize: '16px' }}>
          ...
          <strong>app.logta.com.br</strong> ou the link enviado pela sua empresa.
        </p>
      </div>
    </div>
  );
