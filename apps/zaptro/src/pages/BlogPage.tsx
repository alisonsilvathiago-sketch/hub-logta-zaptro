...
const styles: Record<string, any> = {
  ...
  readMore: { fontSize: '13px', fontWeight: '600', color: 'var(--primary)', display: 'flex', alignItems: 'center', gap: '8px' },
  ...
  sideTitle: { fontSize: '18px', fontWeight: '700', color: '#0F172A', marginBottom: '20px' },
