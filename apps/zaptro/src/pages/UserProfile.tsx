...
const styles: Record<string, any> = {
  ...
  greeting: { fontSize: '36px', fontWeight: '700', color: '#0F172A', margin: 0, letterSpacing: '-1px' },
  ...
  sectionTitle: { fontSize: '24px', fontWeight: '700', color: '#0F172A', margin: 0 },
  editIconBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px', borderRadius: '10px', border: '1px solid #E2E8F0', backgroundColor: 'white', color: '#000', fontWeight: '600', fontSize: '13px', cursor: 'pointer' },
