      ...
      <div style={{ maxWidth: 1300, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 32, paddingBottom: 40 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
             ...
             <button 
                onClick={() => {
                  notifyZaptro('success', 'Convertido!', 'Lead convertido em cliente com sucesso.');
                  navigate(ZAPTRO_ROUTES.CLIENTS);
                }}
                style={{ padding: '12px 28px', borderRadius: 16, border: '1px solid rgba(217, 255, 0, 1)', backgroundColor: 'rgba(217, 255, 0, 0.14)', color: '#000', fontWeight: 800, fontSize: 14, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 10 }}
              >
              ...
              <div style={{ padding: '24px 32px', borderTop: `1px solid ${border}`, backgroundColor: surface }}>
                <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                  ...
                  <button 
                    ...
                    style={{ width: 54, height: 54, borderRadius: 18, border: '1px solid rgba(217, 255, 0, 1)', backgroundColor: 'rgba(217, 255, 0, 0.14)', color: '#000', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', transition: 'transform 0.2s' }}
