...
const styles = {
  ...
  title: { fontSize: '28px', fontWeight: '600', color: 'var(--primary)', letterSpacing: '-0.5px' },
  ...
  tableHeader: { display: 'grid', gridTemplateColumns: '2fr 1.5fr 1fr 1fr 100px', padding: '16px 24px', borderBottom: '2px solid var(--border)', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', textTransform: 'uppercase' as const },
  ...
  summaryTitle: { fontSize: '18px', fontWeight: '600', marginBottom: '20px' },
  statItem: { display: 'flex', justifyContent: 'space-between', marginBottom: '16px' },
  statLabel: { color: '#949494', fontSize: '14px' },
