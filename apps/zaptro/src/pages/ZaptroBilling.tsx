    ...
    <ZaptroLayout>
      <div style={styles.container}>
        ...
        <div style={{ display: 'flex', gap: '24px', marginBottom: '40px' }}>
          <div style={{ ...styles.card, flex: 1, backgroundColor: '#111', color: '#fff', borderColor: '#333' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              <div style={{ width: 40, height: 40, borderRadius: '12px', backgroundColor: 'rgba(217, 255, 0, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <button style={{ width: '100%', padding: '12px', borderRadius: '12px', backgroundColor: '#D9FF00', color: '#000', border: 'none', fontWeight: '700', cursor: 'pointer', fontSize: '13px' }}>
              Comprar Pacote (+1000)
            </button>
          </div>
          ...
          <div style={{ ...styles.card, flex: 1, backgroundColor: '#111', color: '#fff', borderColor: '#333' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              <div style={{ width: 40, height: 40, borderRadius: '12px', backgroundColor: 'rgba(16, 185, 129, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <button style={{ width: '100%', padding: '12px', borderRadius: '12px', backgroundColor: 'transparent', color: '#10B981', border: '1px solid rgba(16, 185, 129, 0.3)', fontWeight: '700', cursor: 'pointer', fontSize: '13px' }}>
              Comprar Pacote IA (+500)
            </button>
          </div>
        </div>
