    ...
    <div style={styles.container} className="animate-fade-in">
      ...
      <div style={styles.grid}>
        {loading ? (
          ...
          <div style={{gridColumn: 'span 3', textAlign: 'center', padding: '100px', color: '#949494', fontWeight: '600'}}>
...
const styles: Record<string, any> = {
  ...
  badge: { display: 'inline-block', padding: '4px 12px', backgroundColor: '#CCFF0015', color: '#0F172A', borderRadius: '30px', fontSize: '10px', fontWeight: '700', marginBottom: '8px', letterSpacing: '1px' },
  title: { fontSize: '40px', fontWeight: '700', color: '#0F172A', letterSpacing: '-2px', marginBottom: '12px' },
  ...
  walletCard: { backgroundColor: 'white', padding: '24px', borderRadius: '24px', border: '1px solid #e8e8e8', display: 'flex', alignItems: 'center', gap: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' },
  ...
  walletLabel: { fontSize: '10px', fontWeight: '700', color: '#949494', textTransform: 'uppercase' as const, letterSpacing: '0.05em' },
  walletValue: { fontSize: '24px', fontWeight: '700', color: '#0F172A', lineHeight: '1' },
  wUnit: { fontSize: '12px', fontWeight: '700', color: '#949494' },
  rechargeBtn: { display: 'flex', alignItems: 'center', gap: '6px', padding: '8px 16px', backgroundColor: '#ebebeb', color: '#0F172A', border: 'none', borderRadius: '10px', fontSize: '12px', fontWeight: '600', cursor: 'pointer' },

  categoryBar: { display: 'flex', gap: '12px', marginBottom: '32px' },
  catBtn: { display: 'flex', alignItems: 'center', gap: '10px', padding: '12px 24px', backgroundColor: 'white', border: '1px solid #E2E8F0', borderRadius: '16px', fontSize: '14px', fontWeight: '600', color: '#949494', cursor: 'pointer', transition: 'all 0.2s' },

  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '24px' },
  productCard: { backgroundColor: 'white', padding: '32px', borderRadius: '32px', border: '1px solid #e8e8e8', display: 'flex', flexDirection: 'column' as const, transition: '0.3s' },
  typeTag: { fontSize: '9px', fontWeight: '700', color: '#0F172A', textTransform: 'uppercase' as const, marginBottom: '16px', backgroundColor: '#CCFF00', padding: '4px 10px', borderRadius: '20px', width: 'fit-content' },
  pName: { fontSize: '20px', fontWeight: '700', color: '#0F172A', marginBottom: '12px', letterSpacing: '-0.5px' },
  pDesc: { fontSize: '14px', color: '#949494', lineHeight: '1.6', marginBottom: '32px', flex: 1, fontWeight: '500' },
  pPriceRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '24px', borderTop: '1px solid #e8e8e8' },
  pPrice: { fontSize: '24px', fontWeight: '700', color: '#0F172A' },
  pCurrency: { fontSize: '14px', color: '#949494', fontWeight: '700', marginRight: '4px' },
  pPeriod: { fontSize: '12px', color: '#949494', fontWeight: '600' },
  buyBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 20px', backgroundColor: '#0F172A', color: 'white', border: 'none', borderRadius: '14px', fontSize: '13px', fontWeight: '700', cursor: 'pointer' },

  checkout: { padding: '10px' },
  orderSummary: { backgroundColor: '#f4f4f4', padding: '20px', borderRadius: '16px', marginBottom: '24px' },
  ...
  orderName: { fontSize: '16px', fontWeight: '700', color: '#0F172A' },
  orderType: { fontSize: '11px', fontWeight: '600', color: '#949494' },
  orderPrice: { marginLeft: 'auto', fontSize: '18px', fontWeight: '700', color: '#0F172A' },
  
  paymentMethod: { marginBottom: '32px' },
  pmHeader: { fontSize: '12px', fontWeight: '700', color: '#949494', marginBottom: '12px' },
  ...
  pmText: { fontSize: '14px', fontWeight: '600', color: '#0F172A' },

  totalRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', padding: '0 8px' },
  totalValue: { fontSize: '28px', fontWeight: '700', color: '#0F172A' },
  confirmBtn: { width: '100%', padding: '20px', backgroundColor: '#0F172A', color: 'white', border: 'none', borderRadius: '18px', fontSize: '16px', fontWeight: '700', cursor: 'pointer', boxShadow: '0 10px 40px rgba(0,0,0,0.1)' },
  secureText: { textAlign: 'center' as const, fontSize: '11px', color: '#949494', marginTop: '20px', fontWeight: '600' }
};
