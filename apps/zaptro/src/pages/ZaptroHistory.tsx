...
const ZaptroHistory: React.FC = () => {
  ...
  const filtered = useMemo(() => {
    ...
    return list;
  }, [rawLog, search, filterType, filterDate]);
      ...
      <div style={styles.container}>
        ...
        <div style={styles.filterBar}>
          ...
          <button
            ...
            style={{
              ...styles.filterBtn,
              borderColor: filterDate === 'hoje' ? '#D9FF00' : '#EBEBEC',
              backgroundColor: filterDate === 'hoje' ? 'rgba(217, 255, 0, 0.1)' : 'white',
            }}
            onClick={() => setFilterDate((prev) => (prev === 'hoje' ? 'todos' : 'hoje'))}
          >
            <Calendar size={18} /> {filterDate === 'hoje' ? 'Hoje' : 'Todas as datas'}
          </button>
