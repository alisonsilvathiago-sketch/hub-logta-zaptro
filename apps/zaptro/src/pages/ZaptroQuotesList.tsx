                  ...
                  <tr key={q.id} style={{ borderBottom: `1px solid ${border}`, cursor: 'pointer' }} onClick={() => setSelectedQuoteDetail(q)}>
                    ...
                    <td style={{ padding: '12px 14px' }}>
                        <a
                          ...
                          rel="noopener noreferrer"
                          title="Abre a página do cliente numa janela pop-up"
                          onClick={(e) => { e.stopPropagation(); quotePublicLinkClick(e, publicUrl); }}
                          style={{
                            display: 'inline-flex',
                            alignItems: 'center',
                            gap: 8,
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
               ...
               <div>
                  ...
                  <p style={{ margin: 0, fontSize: 18, fontWeight: 800, color: LIME }}>{formatBrl(quoteMonetaryValue(selectedQuoteDetail))}</p>
               </div>
