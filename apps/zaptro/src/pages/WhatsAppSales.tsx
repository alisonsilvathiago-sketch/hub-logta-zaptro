...
import { getZaptroAppShellOrigin } from '../utils/domains';
...
const ZaptroMarketing: React.FC = () => {
  ...
  const appOrigin = getZaptroAppShellOrigin();
        ...
        <section className="zt-hero" id="top">
          <div className="zt-hero-inner">
            ...
            <div className="zt-hero-cta zt-hero-an zt-hero-an-3">
              <button type="button" className="zt-btn-black" onClick={() => window.location.href = `${appOrigin}${ZAPTRO_ROUTES.REGISTER}`}>
