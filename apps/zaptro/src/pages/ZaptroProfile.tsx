...
const styles: Record<string, any> = {
  ...
  submitBtn: { padding: '18px 48px', backgroundColor: 'rgba(217, 255, 0, 0.14)', color: '#000', border: '1px solid rgba(217, 255, 0, 1)', borderRadius: '18px', fontWeight: '700', fontSize: '14px', cursor: 'pointer' },
