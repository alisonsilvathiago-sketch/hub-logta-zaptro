...
const styles: Record<string, any> = {
  ...
  cardBrand: { fontSize: '20px', fontWeight: '900', letterSpacing: '2px', textTransform: 'uppercase' },
  mainBadge: { backgroundColor: 'rgba(255,255,255,0.2)', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: '800' },
  ...
  cardValue: { fontSize: '13px', fontWeight: '800', margin: 0 },
