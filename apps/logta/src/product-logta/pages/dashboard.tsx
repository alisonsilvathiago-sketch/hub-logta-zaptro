...
const Dashboard: React.FC = () => {
  ...
  const kpis = [
    ...
    { label: 'Relacionamento (CRM)', value: metrics.totalClients, sub: `${metrics.activeLeads} novos leads`, Icon: UserPlus, color: '#7c3aed', trend: 'Crescente' },
    ...
    { label: 'Frota & Ativos', value: metrics.totalFleet, sub: 'Veículos cadastrados', Icon: Truck, color: '#000000', trend: '100% Up' },
  ...
  const renderAdminView = () => (
    <>
      ...
      <div style={{ ...styles.chartCard, gridColumn: 'span 2', height: '400px', marginBottom: '24px' }}>
         <div style={styles.cardHeader}>
            <h3 style={styles.cardTitle}>Torre de Controle Global (Tempo Real)</h3>
            <div style={styles.liveTag}><div style={styles.liveDot} /> Operacional</div>
         </div>
         <div style={{ flex: 1, height: 'calc(100% - 60px)', borderRadius: '16px', overflow: 'hidden' }}>
            <FleetMap />
         </div>
      </div>
...
const styles = {
  ...
  primaryBtn: { backgroundColor: 'var(--primary)', color: 'white', border: 'none', padding: '12px 24px', borderRadius: '14px', fontWeight: '900', fontSize: '14px', cursor: 'pointer', boxShadow: '0 4px 12px rgba(124, 58, 237, 0.2)' },
  secondaryBtn: { backgroundColor: 'var(--primary-glow)', color: 'var(--primary)', border: '1px solid rgba(124, 58, 237, 0.2)', padding: '10px 20px', borderRadius: '14px', fontWeight: '800', fontSize: '13px', cursor: 'pointer' },
  blackBtn: { backgroundColor: '#000000', color: 'white', border: 'none', padding: '12px 24px', borderRadius: '14px', fontWeight: '900', fontSize: '14px', cursor: 'pointer', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)' },
