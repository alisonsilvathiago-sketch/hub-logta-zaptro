...
const styles: Record<string, any> = {
  ...
  headerTitle: { fontSize: '15px', fontWeight: '800', margin: 0 },
  ...
  recipientSearchRowName: { display: 'block', fontSize: 13, fontWeight: 800, color: '#1e293b' },
  ...
  emptyThreadTitle: { margin: 0, fontSize: '14px', fontWeight: 800, color: '#1e293b' },
