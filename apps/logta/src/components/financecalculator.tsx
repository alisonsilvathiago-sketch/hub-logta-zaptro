...
const FinanceCalculator: React.FC = () => {
  ...
  const styles = {
    ...
    btnEq: { gridColumn: 'span 2', backgroundColor: 'var(--primary)', color: 'white', border: 'none', height: '48px', marginTop: '4px' },
    ...
    shareBox: { backgroundColor: '#f4f4f4', border: '1px solid var(--border)', padding: '16px', borderRadius: '16px', marginTop: 'auto' },
    ...
    <div style={styles.container}>
       ...
       <div style={styles.calcWrap}>
          ...
          <div style={styles.grid}>
             ...
             <button style={{...styles.btn, border: '1px solid var(--primary)', color: 'var(--primary)', marginTop: '4px'}} onClick={saveToHistory}>
       ...
       <div style={styles.historyWrap}>
          ...
          <div style={styles.shareBox}>
             {!isSharing ? (
                <>
                   <p style={{fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '12px', fontWeight: '700'}}>
                ...
                <>
                   <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px'}}>
                      <span style={{fontSize: '12px', fontWeight: '900', color: 'var(--primary)'}}>LINK ATIVO ✅</span>
