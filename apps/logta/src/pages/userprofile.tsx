         ...
         <div style={styles.heroBg}>
            <div style={styles.heroContent}>
               ...
               {userProfile.avatar_url ? (
                  <img src={userProfile.avatar_url} alt="" style={styles.heroAvatar} />
               ) : (
                  <div style={styles.heroAvatarPlaceholder} aria-hidden>
                     {(userProfile.full_name?.trim()?.[0] || '?').toUpperCase()}
                  </div>
               )}
            </div>
         </div>
...
const styles: Record<string, any> = {
  ...
  heroContent: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '100%', padding: 0 },
  ...
  profileWrapper: { maxWidth: '1200px', margin: '-40px auto 0 auto', display: 'flex', gap: '32px', padding: 0, position: 'relative' as const, zIndex: 10 },
  ...
  avatarMini: { width: '48px', height: '48px', borderRadius: '12px', backgroundColor: 'var(--primary)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: '900' },
  ...
  tabActive: { backgroundColor: '#F1F5F9', border: '2px solid var(--primary)', color: 'var(--primary)' },
  ...
  editIconBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px', borderRadius: '10px', border: '1px solid #E2E8F0', backgroundColor: 'white', color: 'var(--primary)', fontWeight: '800', fontSize: '13px', cursor: 'pointer' },
  ...
  input: { height: '48px', padding: '0 16px', borderRadius: '12px', border: '1px solid #E2E8F0', backgroundColor: '#F8FAFC', fontSize: '14px', outline: 'none', transition: '0.2s', '&:focus': { borderColor: 'var(--primary)', backgroundColor: 'white' } },
  saveBtnFull: { height: '54px', width: '100%', marginTop: '40px', backgroundColor: 'var(--primary)', color: 'white', border: 'none', borderRadius: '16px', fontWeight: '800', fontSize: '15px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' },
  ...
  pontoTime: { padding: '4px 10px', backgroundColor: '#DBEAFE', color: 'var(--primary)', borderRadius: '8px', fontWeight: '800' },
  ...
  primaryBtnSmall: { padding: '0 24px', backgroundColor: 'var(--primary)', color: 'white', border: 'none', borderRadius: '12px', fontWeight: '800', fontSize: '13px', cursor: 'pointer' },
