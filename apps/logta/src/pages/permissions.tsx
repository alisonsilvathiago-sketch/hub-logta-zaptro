...
import { LOGTA_PAGE_ROOT_PADDING } from '../constants/logtaLayout';
...
const styles: Record<string, any> = {
  container: { padding: LOGTA_PAGE_ROOT_PADDING, backgroundColor: 'var(--bg-app)', minHeight: '100vh' },
  ...
  avatarMini: { width: '36px', height: '36px', borderRadius: '10px', backgroundColor: 'var(--bg-app)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '800' },
  ...
  panelTitle: { fontSize: '20px', fontWeight: '800', color: 'var(--text-main)' },
  panelSubtitle: { fontSize: '14px', color: 'var(--text-muted)' },
  saveBtn: { display: 'flex', alignItems: 'center', gap: '10px', backgroundColor: 'var(--primary)', color: 'white', border: 'none', padding: '12px 24px', borderRadius: '12px', fontWeight: '800', cursor: 'pointer', transition: 'all 0.2s' },
  
  matrixContainer: { flex: 1, overflowY: 'auto' as const },
  matrixTable: { width: '100%', borderCollapse: 'collapse' as const },
  mThModule: { textAlign: 'left' as const, padding: '16px', fontSize: '12px', fontWeight: '800', color: 'var(--text-muted)', textTransform: 'uppercase' as const, borderBottom: '2px solid var(--border)' },
  mTh: { padding: '16px', fontSize: '11px', fontWeight: '800', color: 'var(--text-muted)', textTransform: 'uppercase' as const, borderBottom: '2px solid var(--border)', textAlign: 'center' as const },
