...
const Marketplace: React.FC = () => {
  ...
  if (loading) {
    return (
      <LogtaPageView style={{ justifyContent: 'center', minHeight: 240 }}>
        <div style={styles.loader}>Sincronizando Catálogo de Soluções...</div>
      </LogtaPageView>
    );
  }

  return (
    <LogtaPageView style={{ gap: 40 }}>
      {/* HERO BANNER */}
...
const styles = {
  ...
  partnerSection: { padding: '40px 48px', backgroundColor: '#f8fafc', borderRadius: '32px', border: '2px dashed #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
