...
const MovementExitAuthorizationTerm: React.FC<Props> = ({
  warehouse,
  product,
  productCode,
  quantity,
  ...
  const warehouseLabel = warehouse?.name ?? 'CD de expedição';
  ...
  return (
    <article className="ls-transfer-auth-term">
      <header className="ls-transfer-auth-term__head">
        ...
        <div>
          <h3 className="ls-transfer-auth-term__title">Termo de autorização de saída</h3>
      ...
      <div className="ls-transfer-auth-term__body">
        <p>
          ...
          <strong>{warehouseLabel}</strong>, autorizo a saída dos itens abaixo para entrega pelo motorista
          identificado, sob minha responsabilidade e ciência dos quantitativos conferidos.
        </p>
        ...
        <p className="ls-transfer-auth-term__legal">
          ...
          equivale à minha anuência para fins de auditoria, rastreio e prevenção de divergências na expedição.
        </p>
      </div>
...
export default MovementExitAuthorizationTerm;
