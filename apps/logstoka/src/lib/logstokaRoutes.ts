export const LOGSTOKA_ROUTES = {
  ...
  SETTINGS_ACCOUNT: '/app/configuracoes/conta',
  ...
  MOVEMENTS_HISTORY: '/app/movements/historico',
  WAREHOUSES: '/app/warehouses',
  warehouseDetail: (warehouseId: string) => `/app/warehouses/${encodeURIComponent(warehouseId)}`,
